 ...
 * ```
 */
class StatefulProcessManagerBuilder {
    _name;
    _eventTypes;
    _stateSchema;
    _contextSchema;
     ...
     */
    clone() {
        const builder = new StatefulProcessManagerBuilder();
        ...
        return {
            ...
            eachBatch: async (events, context) => {
                ...
                for (const event of events) {
                    ...
                    debugBuilder('[stateful-process-manager:%s] State loaded: %s', name, validatedState ? 'existing state' : 'no existing state');
                    // Handle event
...
export function defineStatefulProcessManager() {
    ...
    return new StatefulProcessManagerBuilder();
}
//# sourceMappingURL=stateful-process-manager.js.map